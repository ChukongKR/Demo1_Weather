...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    RESideMenu *sideViewController = [[RESideMenu alloc] initWithContentViewController:[MainWeatherViewController new] leftMenuViewController:[LeftViewController new] rightMenuViewController:nil];
    
    [sideViewController setBackgroundImage:[UIImage imageNamed:@"Stars"]];
